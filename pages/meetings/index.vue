<template>
    <div>
        ...
        <div v-else>
            ...
            <DataTable v-model:expandedRows="expandedRows" :value="meetingsStore.getAllMeetings" dataKey="_id"
                tableStyle="min-width: 60rem">
                    ...
                    <div class="p-4">
                        ...
                        <DataTable :value="slotProps.data.meetings">
                            ...
                            <Column field="volunteers" header="Волонтеры">
                                <template #body="slotProps">
                                    {{ slotProps.data.volunteers?.map((item:any) => item.firstName + ' '+ item.lastName).join(', ') }}
                                </template>
                            </Column>
                        </DataTable>
                    </div>
